...
const ActiveEvent = document.getElementById("Event")
...
let specialNum3 = 3//Math.floor(Math.random() * (100 + point) - point)
...
if((point !== specialNum && point !== specialNum2 && point !== specialNum3)){
    ActiveEvent.textContent = "No Event is acive";
...
if(point == specialNum){
    ActiveEvent.textContent = "Event 1 is acive";
    point--
    console.log("HERE")
    once = 0
...
if(point == specialNum2){
    ActiveEvent.textContent = "Event 2 is acive";
    let left = Math.floor(Math.random() * (boxWidth - 50));
    let bottom = Math.floor(Math.random() * (boxHeight - 50));
...
if(point == specialNum3){
    ActiveEvent.textContent = "Event 3 is acive";
    let left = Math.floor(Math.random() * (boxWidth - 50));
    let bottom = Math.floor(Math.random() * (boxHeight - 50));
